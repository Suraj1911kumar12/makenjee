import { Accordion, AccordionDetails, AccordionSummary, Button, Dialog, DialogActions, DialogContent, DialogTitle, IconButton, Pagination, Paper, Switch, Table, TableBody, TableCell, TableContainer, TableHead, TableRow } from '@mui/material';
...
const VendorServiceType = () => {
    ...
    const handleSwitchChange = (id, status) => {
        ...
        axios.post(`/api/vendor-services/active-inactive-addon`, {
        ...
        <div className="px-[20px]  container mx-auto overflow-y-scroll">
            ...
            >
                ...
                <DialogActions className='justify-between'>
                    ...
                    <span autoFocus className='bg-[#ac87bf] rounded-[8px] border-[#ac87bf] w-[50%] py-[10px] text-center cursor-pointer text-[#fff] hover:opacity-70'>
                        Reject Service
                    </span>
                </DialogActions>
            </BootstrapDialog>
                ...
                <DialogContent dividers>
                    <TableContainer component={Paper}>
                        <Table aria-label="simple table">
                            <TableHead>
                                <TableRow>
                                    <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">Clothing Item Type</TableCell>
                                    <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">Material Type</TableCell>
                                    <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">Status</TableCell>
                                    <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">Add ons</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                {serviceList && serviceList.map((elem) => {
                                    return (
                                        <TableRow
                                            key={elem?.id}
                                            sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                                        >
                                            <TableCell align="center">{elem?.clothing_item_type}</TableCell>
                                            <TableCell align="center">{elem?.material_type.includes("null", null) ? "N/A" : elem?.material_type}</TableCell>
                                            ...
                                            <TableCell align="center">
                                                {/* <button onClick={() => handleClickAddonsList(elem?.addons)}>
                                                    View
                                                </button> */}
                                                <Accordion expanded={openAccordion === elem?.id} onChange={() => setOpenAccordion(openAccordion === elem?.id ? null : elem?.id)}>
                                                    <AccordionSummary>
                                                        <button onClick={() => handleClickAddonsList(elem?.addons)} className='text-[#344054] text-[12px] font-[500]'>
                                                            Click to Expand
                                                        </button>
                                                    </AccordionSummary>
                                                    <AccordionDetails>
                                                        <TableContainer >
                                                            <Table aria-label="simple table">
                                                                <TableHead>
                                                                    <TableRow>
                                                                        <TableCell className='text-[#344054] text-[12px] font-[500]' align="left">Add on name</TableCell>
                                                                        <TableCell className='text-[#344054] text-[12px] font-[500]' align="left">Price</TableCell>
                                                                        <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">Action</TableCell>
                                                                        <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">Status</TableCell>
                                                                        <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">Change Status</TableCell>
                                                                    </TableRow>
                                                                </TableHead>
                                                                <TableBody>
                                                                    {elem?.addons && elem?.addons.map((elem) => {
                                                                        return (
                                                                            <TableRow
                                                                                key={elem?.id}
                                                                                sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                                                                            >
                                                                                <TableCell >{elem?.addon_name}</TableCell>
                                                                                ...
                                                                                <TableCell align="center">
                                                                                    <Switch
                                                                                        ...
                                                                                        onChange={() => handleSwitchChange(elem?.id, elem?.status)}
                                                                                        inputProps={{ 'aria-label': 'controlled' }}
                                                                                        sx={{
                                                                                            '& .Mui-checked + .MuiSwitch-track': {
                                                                                                backgroundColor: elem?.status === 1 ? '#CFAA4C' : '',
                                                                                            },
                                                                                            '& .MuiSwitch-thumb': {
                                                                                                backgroundColor: elem?.status === 1 ? '#CFAA4C' : '',
                                                                                            },
                ...
                <DialogContent dividers>
                    <TableContainer component={Paper}>
                        <Table aria-label="simple table">
                            <TableHead>
                                <TableRow>
                                    <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">Add on Name</TableCell>
                                    <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">price</TableCell>
                                    <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">Status</TableCell>
                                    {/* <TableCell className='text-[#344054] text-[12px] font-[500]' align="center">Change Status</TableCell> */}
                                </TableRow>
                            </TableHead>
                                        ...
                                        >
                                            ...
                                            {/* <TableCell align="center">
                                                <Switch
                                                    ...
                                                    sx={{
                                                        '& .Mui-checked + .MuiSwitch-track': {
                                                            backgroundColor: elem.status == true ? '#ac87bf' : '',
                                                        },
                                                        '& .MuiSwitch-thumb': {
                                                            backgroundColor: elem.status == true ? '#ac87bf' : '',
                                                        },
