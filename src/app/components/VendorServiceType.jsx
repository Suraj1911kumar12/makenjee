          ...
          <div className="m-5">
            ...
            <div className="dropdown">
              <div tabIndex={0} role="button" className="btn m-1">
                Select Service Type <IoMdArrowDropdown size={25} />
              </div>
              <ul
                tabIndex={0}
              ...
              <Table stickyHeader aria-label="sticky table">
                <TableHead>
                  <TableRow className="!bg-[#F9FAFB]">
                    ...
                    <TableCell style={{ minWidth: 200 }}>
                      {`${
                        filterData?.[0]?.material_type !== "null"
                          ? "Meterial Type"
                          : "Clothing Item Type"
                      }`}
                    </TableCell>
                ...
                {filterData.length ? (
                  <TableBody>
                    {filterData.map((elem, i) => {
                      return (
                        <>
                          {/* {console.log(elem.length, "sub data")} */}
                          {/* <TableRow key={i}> */}
                          ...
                          {elem?.approved == 1 && activeTab === "APPROVED" && (
                            <>
                              <TableRow key={i}>
                                <TableCell>{i + 1}</TableCell>
                                ...
                                <TableCell>{elem?.service?.name}</TableCell>
                                <TableCell>
                                  {elem?.material_type !== "null"
                                    ? elem?.material_type
                                    : elem?.clothing_item_type}
                                </TableCell>
                                <TableCell>
                                  {elem?.vendorDetails?.shop_name}
                                </TableCell>
                                <TableCell>{elem?.price}</TableCell>
                                <TableCell>
                          ...
                          {elem?.approved === 0 && activeTab === "REJECTED" && (
                            <>
                              <TableRow key={i}>
                                <TableCell>{i + 1}</TableCell>
                                <TableCell>{serviceName}</TableCell>
