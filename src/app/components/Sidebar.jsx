...
const Sidebar = () => {
  ...
  return (
    <div className="flex h-screen">
          ...
          <div className="flex flex-col space-y-2">
            ...
            >
              <div className="flex items-center justify-between gap-[10px] ">
                ...
                <div className="flex flex-col space-y-1 py-2"></div>
              </div>
            </li>
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "orderList" ? "activeLeftMenu" : ""
              }`}
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "userList" ? "activeLeftMenu" : ""
              }`}
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "sellerList" ? "activeLeftMenu" : ""
              }`}
              onClick={() => handleMenuItemClick("sellerList")}
            >
              <div className="flex items-center justify-between gap-[10px] ">
                <div className="flex item-center gap-[10px]">
                  <Image src={category} height={20} width={20} />
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "driverList" ? "activeLeftMenu" : ""
              }`}
              onClick={() => handleMenuItemClick("driverList")}
            >
              <div className="flex items-center justify-between gap-[10px] ">
                <div className="flex item-center gap-[10px]">
                  <Image src={category} height={20} width={20} />
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "vendorDetails" ? "activeLeftMenu" : ""
              }`}
              onClick={() => handleMenuItemClick("vendorDetails")}
            >
              <div className="flex items-center justify-between gap-[10px] ">
                <div className="flex item-center gap-[10px]">
                  <Image src={category} height={20} width={20} />
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "services" ? "activeLeftMenu" : ""
              }`}
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "serviceType" ? "activeLeftMenu" : ""
              }`}
              onClick={() => handleMenuItemClick("serviceType")}
            >
              <div className="flex items-center justify-between gap-[10px] ">
                <div className="flex item-center gap-[10px]">
                  <Image src={category} height={20} width={20} />
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "vendorServiceType" ? "activeLeftMenu" : ""
              }`}
              onClick={() => handleMenuItemClick("vendorServiceType")}
            >
              <div className="flex items-center justify-between gap-[10px] ">
                <div className="flex item-center gap-[10px]">
                  <Image src={category} height={20} width={20} />
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "Addons" ? "activeLeftMenu" : ""
              }`}
              onClick={() => handleMenuItemClick("Addons")}
            >
              <div className="flex items-center justify-between gap-[10px] ">
                <div className="flex item-center gap-[10px]">
                  <Image src={category} height={20} width={20} />
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "invoices" ? "activeLeftMenu" : ""
              }`}
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "banks" ? "activeLeftMenu" : ""
              }`}
              onClick={() => handleMenuItemClick("banks")}
            >
              <div className="flex items-center justify-between gap-[10px] ">
                <div className="flex item-center gap-[10px]">
                  <Image src={category} height={20} width={20} />
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "pincodes" ? "activeLeftMenu" : ""
              }`}
              onClick={() => handleMenuItemClick("pincodes")}
            >
              <div className="flex items-center justify-between gap-[10px] ">
                <div className="flex item-center gap-[10px]">
                  <Image src={category} height={20} width={20} />
            ...
            {/* <li className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${activeComponent === 'aboutUs' ? 'activeLeftMenu' : ''}`} onClick={() => handleMenuItemClick('aboutUs')}>
                            <div className='flex items-center justify-between gap-[10px] ' >
                                <div className='flex item-center gap-[10px]'>
                                    ...
                                    <div>
                                        <div >
                                            <span className='text-[15px] hover:text-[#FCF8EE]'>About Us</span>
                                        </div>
                                    </div>
                                </div>
                                <div className='flex flex-col space-y-1 py-2'>
            ...
            <li
              className={`leftMenuHover p-[10px] rounded-[8px] cursor-pointer ${
                activeComponent === "vendorPayouts" ? "activeLeftMenu" : ""
              }`}
              onClick={() => handleMenuItemClick("vendorPayouts")}
            >
              <div className="flex items-center justify-between gap-[10px] ">
                <div className="flex item-center gap-[10px]">
                  <Image src={category} height={20} width={20} />
      ...
      {activeComponent === "Addons" && <Addons />}

      {activeComponent === "vendorServiceType" && <VendorServiceType />}

      {activeComponent === "vendorPayouts" && <VendorPayouts />}
