...
const Category = () => {
  ...
  const handleEditCategory = () => {
    ...
    axios.post(`/api/category/${editData.id}`, formData, {
      headers: {
        Authorization: localStorage.getItem('mykanjeeAdminToken'),
        'Content-Type': 'multipart/form-data',
      },
                ...
                <Table stickyHeader aria-label="sticky table">
                  <TableHead>
                    <TableRow className='!bg-[#F9FAFB]'>
                      ...
                      <TableCell style={{ minWidth: 100 }}>Product Count</TableCell>
                  ...
                  {filteredRows.length > 0 ?
                    ...
                    :
                    <TableRow>
                      <TableCell colSpan={7} className='text-center text-[15px] font-bold'>No Categories found</TableCell>
                    </TableRow>
                  }
                </Table>
              </TableContainer>
